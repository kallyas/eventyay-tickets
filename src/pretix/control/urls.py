...
urlpatterns = [
    ...
    re_path(r'^event/(?P<organizer>[^/]+)/(?P<event>[^/]+)/', include([
        ...
        re_path(r'^orders/import/(?P<file>[^/]+)/$', orderimport.ProcessView.as_view(), name='event.orders.import'
                                                                                             '.process'),
        ...
        re_path(r'^checkinlists/(?P<list>\d+)/$', checkin.CheckInListShow.as_view(), name='event.orders.checkinlists'
                                                                                          '.show'),
